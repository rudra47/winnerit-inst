							...
							<form action="{{ route('user.updateProfile') }}" method="post">
								...
								<div class="form-group">
									<div class="row">
										<div class="col-md-6">
											<label>Name</label>
											<input type="text" name="name" value="{{$UseruserInfo->name}}" class="form-control">
										</div>
										<div class="col-md-6">
								...
								<div class="form-group">
									<div class="row">
										...
										<div class="col-md-6">
											<label>Address</label>
											<input type="text" name="address" value="{{$UseruserInfo->address}}" class="form-control">
										</div>
									</div>
								</div>
	...
	<div class="col-lg-3">
		...
		<div class="thumbnail">
	    	...
	    	<div class="caption text-center">
	    		<h6 class="text-semibold no-margin">{{$UseruserInfo->name}} <small class="display-block">{{$userInfo->designation}}</small></h6>
