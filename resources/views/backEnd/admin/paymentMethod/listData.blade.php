    ...
    <div class="content">
        <div class="panel panel-flat">
            <div class="panel-body">
                <form class="form-horizontal form-validate-jquery" action="{{route('admin.paymentMethod.store')}}" method="POST">
                    @csrf
                ...
                <tbody>
                    ...
                    <tr key = {{$key}}>
                        ...
                        <td class="text-center ">
                            {{-- <a link="{{route('admin.paymentMethod.edit', [$paymentMethod->id])}}" update-link="{{route('admin.paymentMethod.update', [$paymentMethod->id])}}" class="action-icon edit"><i class="icon-pencil7"></i></a> --}}
                            <a href="{{route('admin.paymentMethod.edit', [$paymentMethod->id])}}" class="action-icon"><i class="icon-pencil7"></i></a>
                            <a class="action-icon destroy" delete-link="{{route('admin.paymentMethod.destroy', [$paymentMethod->id])}}">
